  ...
  return (
    ...
    >
      ...
      <img
        src={images[0]}
        alt={title}
        className="w-full h-64 object-cover transition-transform duration-300 scale-110"
      />
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 transform translate-y-0 transition-transform duration-300 z-20">
