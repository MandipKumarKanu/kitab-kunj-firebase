...
const MyDeclinedBooks = () => {
        ...
        if (bookIdFromState) {
          ...
          if (book) {
            ...
            const bookDoc = await getDoc(
              doc(db, "declinedBooks", bookIdFromState)
            );
            if (bookDoc.exists()) {
  ...
  return (
    <div className="container mx-auto ">
      ...
      {declinedBooks.length === 0 ? (
        <p className="text-gray-600 text-lg">
          You don't have any declined books.
        </p>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {declinedBooks.map((book) => (
            <div
              key={book.id}
            ...
            <div className="p-4 md:p-8 pt-2 max-h-[90vh] overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  {selectedBook.declineReason && (
                    <div className="bg-red-50 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-sm">
...
export default MyDeclinedBooks;
